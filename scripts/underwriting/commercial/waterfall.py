"""
waterfall.py — Acquisition waterfall for commercial deals.

Thin shim that adapts the multifamily waterfall (../waterfall_acq) to a
CommercialProForma. The vendor waterfall only consumes equity_flows_total +
...
def run_commercial_waterfall(pf: CommercialProForma) -> WaterfallResult:
    deal = pf.deal
